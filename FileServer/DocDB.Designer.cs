...
namespace FileServer {
    ...
    public partial class DocDB : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DocDB.xsd";
        ...
        public partial class FilesDataTable : global::System.Data.TypedTableBase<FilesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public FilesRow AddFilesRow(int DocType, string FileName, string StoragePath) {
        ...
        public partial class FilesRow : global::System.Data.DataRow {
            ...
            public int DocType {
                get {
                    return ((int)(this[this.tableFiles.DocTypeColumn]));
                }
                set {
                    this[this.tableFiles.DocTypeColumn] = value;
                }
            }
...
namespace FileServer.DocDBTableAdapters {
    ...
    public partial class FilesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Files] WHERE (([FileID] = @Original_FileID) AND ([DocType] = @" +
                "Original_DocType) AND ((@IsNull_StoragePath = 1 AND [StoragePath] IS NULL) OR ([" +
                "StoragePath] = @Original_StoragePath)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_StoragePath", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StoragePath", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_StoragePath", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StoragePath", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Files] ([DocType], [FileName], [StoragePath]) VALUES (@DocType" +
                ", @FileName, @StoragePath);\r\nSELECT FileID, DocType, FileName, StoragePath FROM " +
                "Files WHERE (FileID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Files] SET [DocType] = @DocType, [FileName] = @FileName, [StoragePath] = @StoragePath WHERE (([FileID] = @Original_FileID) AND ([DocType] = @Original_DocType) AND ((@IsNull_StoragePath = 1 AND [StoragePath] IS NULL) OR ([StoragePath] = @Original_StoragePath)));
SELECT FileID, DocType, FileName, StoragePath FROM Files WHERE (FileID = @FileID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_StoragePath", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StoragePath", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_StoragePath", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StoragePath", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FileServer.Properties.Settings.Default.SupportingDocDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "select * from dbo.Files";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "select * from dbo.Files where FileID=@id";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "FileID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DocDB.FilesDataTable dataTable) {
        ...
        public virtual DocDB.FilesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DocDB.FilesDataTable dataTable = new DocDB.FilesDataTable();
        ...
        public virtual int FillById(DocDB.FilesDataTable dataTable, int id) {
        ...
        public virtual DocDB.FilesDataTable GetDataById(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            DocDB.FilesDataTable dataTable = new DocDB.FilesDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DocDB.FilesDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DocDB dataSet) {
        ...
        public virtual int Delete(int Original_FileID, int Original_DocType, string Original_StoragePath) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_FileID));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_DocType));
            if ((Original_StoragePath == null)) {
                this.Adapter.DeleteCommand.Parameters[2].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.DeleteCommand.Parameters[2].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_StoragePath));
            }
        ...
        public virtual int Insert(int DocType, string FileName, string StoragePath) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(DocType));
            if ((FileName == null)) {
            ...
            if ((StoragePath == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(StoragePath));
            }
        ...
        public virtual int Update(int DocType, string FileName, string StoragePath, int Original_FileID, int Original_DocType, string Original_StoragePath, int FileID) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(DocType));
            if ((FileName == null)) {
            ...
            if ((StoragePath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(StoragePath));
            }
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_FileID));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_DocType));
            if ((Original_StoragePath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_StoragePath));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int DocType, string FileName, string StoragePath, int Original_FileID, int Original_DocType, string Original_StoragePath) {
            return this.Update(DocType, FileName, StoragePath, Original_FileID, Original_DocType, Original_StoragePath, Original_FileID);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(DocDB dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._filesTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(DocDB dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._filesTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(DocDB dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._filesTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(DocDB dataSet) {
            if ((dataSet == null)) {
